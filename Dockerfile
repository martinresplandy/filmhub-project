...
RUN DJANGO_SECRET_KEY=${DJANGO_SECRET_KEY} DJANGO_SETTINGS_MODULE=filmhub.settings /py/bin/python manage.py collectstatic --noinput --verbosity 3# Expose the default port
EXPOSE 8000
